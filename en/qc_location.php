...
<head>
    ...
    <title>QC Location Management</title>
            ...
            <table>
                ...
                <?php foreach ($locations as $location): ?>
                    <tr>
                        ...
                        <td>
                            <button class="small-button" onclick="confirmEdit(<?= $location['loc_id'] ?>, '<?= htmlspecialchars($location['loc_name']) ?>')">Edit</button>
                            <button class="small-button" onclick="confirmDelete(<?= $location['loc_id'] ?>, '<?= htmlspecialchars($location['loc_name']) ?>')">Delete</button>
                        </td>
                    </tr>
                <?php endforeach; ?>
                <tr>
