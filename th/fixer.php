...
<head>
    ...
    <title>หน้าหลักนักปรับแต่งเพลง</title>
...
<body>
    ...
    <div class="content">
        ...
        <div class="left-section">
            <button onclick="location.href='song_ack.php'">ตอบรับ</button>
            <p><?= htmlspecialchars($x); ?> เพลงที่รอการแก้ไข</p>
        </div>

        <!-- Middle Section for Update Button, Root Cause Button, and Counts -->
        <div class="left-section">
            <button onclick="location.href='song_update.php'">อัปเดต</button>
            <p><?= htmlspecialchars($y); ?> เพลงที่รอการแก้ไข</p>
            <button onclick="location.href='cause.php'">สาเหตุหลัก</button>
            <p><?= htmlspecialchars($x2); ?> เพลงที่รอการแก้ไข</p>
        </div>
